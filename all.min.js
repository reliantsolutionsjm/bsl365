...
$("<style>")
    ...
    .appendTo("head");
        ...
        function getPensionInfo(record, employee) {
            const pension = calculatePension(employee.IDnum, record.calculatedGrossPay);
            if (pension <= 0) {
                return {
                    title: "",
                    amount: "",
            ...
            return {
               ...
               const columnInfo = getColumnInfo(adjustcolumns, adjustcolumns2, [
                ...
                const grossInfo = getGrossInfo(record);
                function getGrossInfo(record) {
                    if (!record.calculatedGrossPay || record.calculatedGrossPay === 0) {
                        return {
                            gross: "N/A",
                            gross_val: "N/A",
                            tax: "N/A",
                    ...
                    // 1. Calculate all earnings components
                    ...
                    const totalGross = regularPay + sickPay + overtimePay + holidayPay + vacationPay + doubleTimePay + personalPay + otherPay + (record.Travel || 0) + (record.Incentive || 0) + (record.Allowance || 0);
                    ...
                    const setNetPay = (totalGross - (record.calculatedTaxs + variableDeductions));
                    ...
                    return {
                        ...
                        //net_val: formatCurrency(record.calculatedNetPay || 0),
                        deduct_Val: formatCurrency(variableDeductions),
                        line: "<br>",
                        visible: "block"
                    };
                }
